...
Sub Printout()
    ...
    response.write "             <h2>Y&B Medicare and Fertitlity Centre</h2>"
    response.write "             <p style='text-align: left;'>Tel: <b>+233 554 110224</b> | Email: info@y&bmedicareandfertilitycentre.com</p>"
    response.write "             <p style='text-align: left;'>Location: Margaret Anderson Avenue, Westlands, Accra, Ghana</p>"
