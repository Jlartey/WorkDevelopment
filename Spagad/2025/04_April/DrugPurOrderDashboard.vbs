    ...
    With rst
        ...
        If rst.recordCount > 0 Then
            ...
            Do While Not rst.EOF
                ...
                phref = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=DrugPurOrder&PositionForTableName=DrugPurOrder&DrugPurOrderID=" & purID
                ...
                Else
                    ...
                    sTb2 = "DrugPurOrderPro"
                    'by Mike
                     If HasAccessRight(uname, "frm" & sTb2, "New") And Glob_HasTransProcessAccess(sTb2, uname, "T002", "T003") Then
                        lnkText = "Approve Purchase Request"
                ...
                Else
                    ...
                    sTb2 = "DrugPurOrderPro"
                    'by Mike
                     If HasAccessRight(uname, "frm" & sTb2, "New") And Glob_HasTransProcessAccess(sTb2, uname, "T003", "T004") Then
                        lnkText = "Approve Purchase Request"
