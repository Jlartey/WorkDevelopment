...
Sub Printout()
    ...
    Dim rst, sql, tot, item, qty, ucst, amt, uom, famt, acc
    ...
    response.write "        <h3>Purchase Order No: " & GetRecordField("ItemPurOrderID") & "</h3>"
    response.write "      </div>"
    response.write "    </div>"
    response.write ""
    ...
    sql = "select * from ItemPurOrderItems where itempurorderid='" & Trim(GetRecordField("ItemPurOrderID")) & "' order by itemid"
    With rst
        .open sql, conn, 3, 4
        If .recordCount > 0 Then
            ...
            Do While Not .EOF
                ...
                tot = tot + amt
                response.write "          <tr>"
                response.write "            <td class=""mytd"">" & UCase(item) & "</td>"
                response.write "            <td class=""mytd"">" & GetComboName("Item", item) & "</td>"
    ...
    sql = "select * from itemPurOrderItems2 where itempurorderid='" & Trim(GetRecordField("itempurorderid")) & "' order by itemid"
    With rst
        .open sql, conn, 3, 4
        If .recordCount > 0 Then
            .MoveFirst
    ...
    response.write "          </tr>"
    famt = tot
    If UCase(GetRecordField("ItemPurOrderCatID")) = "I001" Then
        acc = 0.04 * tot
        response.write "          <tr>"
        response.write "            <td class=""mytd""></td>"
        response.write "            <td class=""mytd""></td>"
        response.write "            <td colspan=""3"" class=""mytd tdr"">"
        response.write "              <strong>VAT(4%)</strong>"
        response.write "            </td>"
        response.write "            <td class=""mytd tdr""><strong>" & FormatNumber(acc, 2, , , -1) & "</strong></td>"
        response.write "          </tr>"
        famt = famt + acc
    ElseIf UCase(GetRecordField("ItemPurOrderCatID")) = "I002" Then
        acc = 0.025 * tot
        response.write "          <tr>"
        response.write "            <td class=""mytd""></td>"
        response.write "            <td class=""mytd""></td>"
        response.write "            <td colspan=""3"" class=""mytd tdr"">"
        response.write "              <strong>NHIL(2.5%)</strong>"
        response.write "            </td>"
        response.write "            <td class=""mytd tdr""><strong>" & FormatNumber(acc, 2, , , -1) & "</strong></td>"
        response.write "          </tr>"
        famt = famt + acc
        ...
        response.write "            <td class=""mytd""></td>"
        response.write "            <td colspan=""3"" class=""mytd tdr"">"
        response.write "              <strong>GETFUND(2.5%)</strong>"
        response.write "            </td>"
        response.write "            <td class=""mytd tdr""><strong>" & FormatNumber(acc, 2, , , -1) & "</strong></td>"
        response.write "          </tr>"
        famt = famt + acc
        ...
        response.write "            <td class=""mytd""></td>"
        response.write "            <td colspan=""3"" class=""mytd tdr"">"
        response.write "              <strong>COVID-19(1%)</strong>"
        response.write "            </td>"
        response.write "            <td class=""mytd tdr""><strong>" & FormatNumber(acc, 2, , , -1) & "</strong></td>"
        response.write "          </tr>"
        famt = famt + acc
        ...
        response.write "            <td class=""mytd""></td>"
        response.write "            <td colspan=""3"" class=""mytd tdr"">"
        response.write "              <strong>VAT(15%)</strong>"
        response.write "            </td>"
        response.write "            <td class=""mytd tdr""><strong>" & FormatNumber(acc, 2, , , -1) & "</strong></td>"
        response.write "          </tr>"
        famt = famt + acc
    ...
    response.write "            </td>"
    response.write "            <td class=""mytd tdr""><strong>" & FormatNumber(famt, 2, , , -1) & "</strong></td>"
    response.write "          </tr>"
    response.write "        </tbody>"
    ...
    response.write "      <p><strong>Payment Terms: </strong><span>" & GetComboName("PerformVar21", GetRecordField("PurchaseOrderInfo2")) & "</span></p>"
    response.write "    </div>"
    response.write ""
    ...
    GetTC GetRecordField("KeyPrefix")
    response.write "    </div>"
    response.write "  </div>"
...
Sub GetTC(str)
    ...
    If str <> "" Then
        For Each Line In Split(str, "|||")
            arr = Split(Line, "::")
            response.write "      <p>"
            response.write "        <label><u>" & UCase(Trim(arr(0))) & ":</u></label>"
            response.write "        <span"
            response.write "          >" & Replace(Trim(arr(1)), "\\n", "<br>") & "</span>"
            response.write "      </p>"
        Next
    Else
        response.write "      <p>"
