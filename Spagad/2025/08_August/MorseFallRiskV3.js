const scoreConfig = {
  mfs: {
    totalElement: document.getElementById(
      'EMR050^^EMR05035Column11EMRVAR2B-FRAS01^^FRAS01.4Column2'
    ),
    riskLevelElement: document.getElementById(
      'EMR050^^EMR05035Column11EMRVAR2B-FRAS01^^FRAS01.4Column5'
    ),
    riskThresholds: { low: 25, moderate: 45 },
    categories: {
      falls: {
        name: 'EMR050^^EMR05035Column11EMRVAR2B-FRAS01^^FRAS01.1Column2',
        scores: [0, 0, 15, 25],
        sum: 0,
      },
      amb_aid: {
        name: 'EMR050^^EMR05035Column11EMRVAR2B-FRAS01^^FRAS01.1Column5',
        scores: [0, 0, 15, 30],
        sum: 0,
      },
      gait: {
        name: 'EMR050^^EMR05035Column11EMRVAR2B-FRAS01^^FRAS01.2Column2EMR050^^FRAS01.2Column2',
        scores: [0, 0, 10, 20],
        sum: 0,
      },
      mental: {
        name: 'EMR050^^EMR05035Column11EMRVAR2B-FRAS01^^FRAS01.2Column5',
        scores: [0, 0, 15],
        sum: 0,
      },
      review: {
        name: 'EMR050^^EMR05035Column11EMRVAR2B-FRAS01^^FRAS01.3Column2',
        scores: [0, 0, 10],
        sum: 0,
      },
    },
