    ...
    If rst.recordCount > 0 Then
        ...
        Do While Not rst.EOF
            If lastLabTest <> (rst.fields("targTbl")) Then
                ...
                htmlStr = htmlStr & "       <tr>"
                htmlStr = htmlStr & "           <th class='inv-name' colspan=""100"" style=""text-align:left;"">" & ltName & " -> [" & GetComboName("TestCategory", GetComboNameFld("LabTest", rst.fields("LabTestID"), "TestCategoryID")) & "]</th>"
                htmlStr = htmlStr & "       </tr>"
                htmlStr = htmlStr & "   </thead>"
                htmlStr = htmlStr & "   <tbody>"
            End If
...
Function DisplayHead(LabRequestID)
    ...
    If rst.recordCount > 0 Then
        ...
        str = str & "<table class='report-header' style='margin:auto;'>"
            str = str & "<tr><td align=""center"" height=""100""><img src='images/letterhead5.jpg' style='width:177mm;height:90px;'></td></tr>"
