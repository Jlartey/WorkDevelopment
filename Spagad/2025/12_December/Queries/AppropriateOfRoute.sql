...
WITH EMRResultsCTE AS (
    SELECT
       CONVERT(VARCHAR(20), er.Column5) AS EMRVar3BID, 
        req.EMRDate,
        req.VisitationID
...
EMRVar2BCTE AS (
    SELECT *
    FROM dbo.EMRVar3B
    WHERE CONVERT(VARCHAR(20), EMRVar3AID) = 'E059'
    )
SELECT 'Appropriateness of Route' EMRVar3BID, EMRDate, VisitationID, EMRVar3BName,EMRVar3AID 
FROM EMRResultsCTE 
