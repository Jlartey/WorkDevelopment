...
recPerPg = 5000
  ...
  If rst0.recordCount > 0 Then
    ...
    Do While Not rst0.EOF
      ...
      response.write "<table class='mytable' border=""1"" cellpadding=""2"" cellspacing=""0"" style=""font-size: 8pt; font-family: Arial; border-collapse:collapse;page-break-after:always"">"
...
dispOption "S21"
      ...
      With rst
        If .recordCount > 0 Then
          ...
          pgStr = "<table class='mytable' border=""0"" cellpadding=""3"" cellspacing=""0"" style=""font-size: 8pt; font-weight:bold; border-collapse:collapse""><tr>"
          pgStr = pgStr & "<td class='mytd' style=""font-size: 9pt; font-weight:normal"">FIND&nbsp;:&nbsp;</td>"
          For num = 1 To .PageCount
            .AbsolutePage = num
            pgStr = pgStr & "<td class='mytd'><a href=""" & Replace(pgUrl, "POSITIONFORRECPAGENUMBER", CStr(num)) & """>" & Left(.fields("DrugName"), 3) & "</a></td>"
          Next
...
If Len(rackid) > 0 Then
          ...
          response.write "<th class='myth' colspan=""15"" align=""center"">" & UCase(rackid) & "</th>"
          response.write "</tr>"
End If
          'Header
    
          response.write "<tr class='mytr'>"
          response.write "<td class='mytd'><b>NO.</b></td>"
          response.write "<td class='mytd'><b>DRUGID</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>DRUG</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>U.PRICE</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>UOM</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>TYPE</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>BATCH</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>RACK</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>CURR. LEV</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>TOT</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>BIN CARD NO.</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>ADJUSTMENT</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center""><b>EXPIRY DATE</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center"" width=""140""><b>STOCK TAKE</b></td>"
          response.write "<td class='mytd' valign=""top"" align=""Center"" width=""140""><b>REMARKS</b></td>"
          ...
          Do While Not .EOF And recCnt < CInt(recPerPg)
            ...
            response.write "<tr class='mytr'>"
            response.write "<td class='mytd'><b>" & CStr(recPos) & "</b></td>"
            response.write "<td class='mytd'>" & UCase(drg) & "</td>"
            response.write "<td class='mytd'>" & UCase(drgNm) & "</td>"
            response.write "<td class='mytd' align=""right"">" & FormatNumber(stkPr, 4, , , -1) & "</td>" 'Price
            response.write "<td class='mytd'>" & UCase(uom) & "</td>"
            response.write "<td class='mytd'>" & UCase(typ) & "</td>"
            response.write "<td class='mytd'>" & UCase(batch) & "</td>"
            response.write "<td class='mytd'>" & UCase(rck) & "</td>"
            response.write "<td class='mytd' align=""right"">" & CStr(stkTot) & "</td>"
            response.write "<td class='mytd' align=""right"">" & FormatNumber(tot, 2, , , -1) & "</td>" 'Price
            response.write "<td class='mytd' align=""right""></td>"
            response.write "<td class='mytd' align=""right""></td>"
            response.write "<td class='mytd' align=""right"">" & UCase(expiryDate) & "</td>"
            response.write "<td class='mytd' align=""right""></td>"
            response.write "<td class='mytd' align=""right""></td>"
          ...
          response.write "<td class='mytd' align=""center"" colspan=""7""><b>TOTALS</b></td>"
          response.write "<td class='mytd' align=""right""><b>" & FormatNumber(gTot, 2, , , -1) & "</b></td>"
          response.write "<td class='mytd'colspan=""""></td>"
          response.write "</tr>"
          'Paging
'          response.write "<tr>"
...
response.write "<tr class='mytr'>"
response.write "<td class='mytr' align=""center"">"
response.write "<table class='mytable' border=""0"" width=""" & (PrintWidth) & """ cellspacing=""0"" cellpadding=""0"">"
response.write "<tr>"
AddReportHeader
response.write "</tr>"
response.write "</table>"
...
response.write "</tr>"
response.write "<tr class='mytr'>"
response.write "<td class='mytd' align=""center""><hr color=""#999999"" size=""1""></td>"
response.write "</tr>"

'response.write "<style type=""text/css"">"
'response.write "@page { size: A4 landscape; margin: 8mm 10mm; }"
'response.write "@media print {"
'response.write "  body { font-family: Arial, Helvetica, sans-serif; font-size: 9pt; }"
'response.write "  .mytable { page-break-inside: avoid; }"
'response.write "  .mytr { page-break-inside: avoid; page-break-after: auto; }"
'response.write "  .mythead { display: table-header-group; }"
'response.write "  .no-print { display: none; }"
'response.write "}"
'response.write ".mytable {"
'response.write "  width: 95vw; border-collapse: collapse; font-size: 9pt;"
'response.write "}"
'response.write ".myth, .mytd {"
'response.write "  border: 1px solid #000; padding: 8px; vertical-align: middle;"
'response.write "}"
'response.write ".myth {"
'response.write "  background-color: #f0f0f0; font-weight: bold; text-align: center;"
'response.write "}"
'response.write ".mytd { height: 45px; }"  '<!-- Gives space to write by hand -->
'response.write ".mytd.right { text-align: right; }"
'response.write ".mytd.center { text-align: center; }"
'response.write ".mytr:nth-child(even) { background-color: #f9f9f9; }"  '<!-- Zebra striping -->
'response.write ".wide { width: 180px; }"  '<!-- For STOCK TAKE and REMARKS -->
'response.write ".medium { width: 120px; }"
'response.write ".rack-title {"
'response.write "  font-size: 18pt; font-weight: bold; text-align: center; margin: 20px 0; background-color: #e0e0e0; padding: 10px;"
'response.write "}"
'response.write "</style>"
'Title
response.write "<tr class='mytr'>"
response.write "<td class='mytr' align=""center"" bgcolor=""#FFFFFF"" >"
response.write "<table class='mytable' border=""0"" cellspacing=""0"" cellpadding=""2"" bgcolor=""White"" style=""font-family: Arial; color: #111111; font-weight:bold; font-size:9pt"">"
response.write "<tr class='mytr'>"
response.write "<td class='mytd'>TITLE : </td>"
response.write "<td class='mytd'>DRUGS STOCK TAKE SHEET</td>"
response.write "</tr>"
response.write "<tr class='mytr'>"
response.write "<td class='mytd'>STORE : </td>"
response.write "<td class='mytd'>" & UCase(GetComboName("DrugStore", stoSlt)) & " [" & UCase(stoSlt) & "]</td>"
response.write "</tr>"
response.write "<tr class='mytr'>"
response.write "<td class='mytd'>DATE : </td>"
response.write "<td class='mytd'> AS AT " & (FormatDateDetail(CDate(dat1))) & "</td>"
response.write "</tr>"
response.write "</table>"
...
response.write "</tr>"
response.write "<tr class='mytr'>"
response.write "<td class='mytd' align=""left"">"
response.write "<table class='mytable' border=""0"" width=""" & (PrintWidth) & """ cellspacing=""0"" cellpadding=""0"" bgcolor=""White"" style=""font-size: 9pt; font-family: Arial"">"
response.write "<tr class='mytr'>"
response.write "<td class='mytd' align=""center"">"

response.write "<table class='mytable' border=""0"" width=""100%"" cellspacing=""0"" cellpadding=""0"">"
'response.write "<tr><td valign=""top"" colspan=""3""><hr color=""#999999"" size=""1"">"
'response.write "</td></tr>"
response.write "<tr class='mytr'><td class='mytd' valign=""top"" colspan=""3"">"
TrackDrugStock
response.write "</td>"
response.write "</tr>"
response.write "</table>"
