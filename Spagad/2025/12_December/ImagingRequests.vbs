...
Sub ImagingRequests()
    ...
    sql = "SELECT DoctorName, COUNT(LabRequestID) Tests "
    sql = sql & "From Investigation2 "
    sql = sql & "WHERE TestCategoryID = 'B19' "
    sql = sql & "AND RequestDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "' "
    sql = sql & "GROUP BY DoctorName"
    ...
    With rst
        ...
        If .recordCount > 0 Then
            ...
            response.write "<th class='myth'>IMAGING REQUESTS</th>"
            response.write "</tr class='mytr'>"
            ...
            Do While Not .EOF
                ...
                response.write "<td class='mytd'>" & .fields("Tests") & "</td>"
                response.write "</tr class='mytr'>"
