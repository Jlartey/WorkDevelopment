...
recPerPg = 5000
  ...
  If rst0.recordCount > 0 Then
    ...
    Do While Not rst0.EOF
      ...
      sql = "select top 500 drug.drugname,drugstocklevel.drugid,drug.RetailUnitCost,drugtype.drugtypename,COALESCE(performvar22.performvar22name, 'No Rack') AS performvar22name,unitofmeasure.unitofmeasurename "
