...
' sql = sql & " JOIN SystemUser ON Diagnosis.SystemUserID = SystemUser.SystemUserID "
' sql = sql & " JOIN Staff ON SystemUser.StaffID = Staff.StaffID "
' sql = sql & " WHERE Diagnosis.VisitationID = vst.VisitationID) AS [Attending Doctor],"
...
sql = sql & ") AS temp ON temp.visitationid = vst.VisitationID "
sql = sql & "LEFT JOIN ("
...
sql = sql & ") AS wg ON wg.visitationid = vst.VisitationID "
sql = sql & "LEFT JOIN ("
...
sql = sql & ") AS ht ON ht.visitationid = vst.VisitationID "
