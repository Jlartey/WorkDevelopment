...
sql = ""
sql = sql & " SELECT ItemPurOrderID, SupplierTypeID, PurchaseOrderDate, SupplierID, ItemPurOrderTypeID, ItemPurOrderStatusID, ItemCategoryID, SystemuserID, TransProcessValID"
    ...
    With rst
        ...
        If rst.recordCount > 0 Then
            ...
            Do While Not rst.EOF
                ...
                ' phref = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=ItemPOPrint&PositionForTableName=ItemPurOrder&ItemPurOrderID=" & purID
