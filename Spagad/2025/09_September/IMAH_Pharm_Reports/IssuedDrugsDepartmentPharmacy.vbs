...
storeID = Trim(Request.QueryString("Printfilter1"))
...
Set rptGen = New PRTGLO_RptGen
    ...
    sql = sql & " AND DrugRequestStore.DrugRequestStoreID = 'S22' AND DrugStore.DrugStoreID = '" & storeID & "' "
    sql = sql & " ORDER BY Drug.DrugName ASC"
    
    
args = "showcolumntotal=yes;SubGroupFields=Drug Name;hiiddenfields=store|ID;formatmoneyfields=RetailUnitCost|Total Amt;"
