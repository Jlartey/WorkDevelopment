    ...
    With rst
        ...
        If .recordCount > 0 Then
            ...
            staffName = .fields("Doctor")
                ...
                response.write "<td class='mytd' style='cursor: pointer; color: blue' onclick='redirectToConsultDetails(""" & server.HTMLEncode(staffName) & """, """ & server.HTMLEncode(periodStart) & """, """ & server.HTMLEncode(periodEnd) & """)'><u>View More</u></td>"
                response.write "</tr class='mytr'>"
            ...
            response.write "    function redirectToConsultDetails(staffName, periodStart, periodEnd) {"
