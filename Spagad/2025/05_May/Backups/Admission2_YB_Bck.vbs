...
response.write "<div id='sigs'><div class='lft'><p><small>PREPARED BY: <span>SHERITA DOGBEY</span></small></p> <p>SIGN: <span></span></p> <p>DATE: <span>" & (FormatDateDetail(GetRecordField("AdmissionDate"))) & "</span></p></div> <div class='rgt'><p><small>CLAIM OFFICER NAME: <span>SHERITA DOGBEY</span></small></p> <p>SIGN: <span></span></p> <p>DATE: <span>" & (FormatDateDetail(Now())) & "</span></p></div></div>"
response.write "</td>"
response.write "</tr>"
End If
.Close
