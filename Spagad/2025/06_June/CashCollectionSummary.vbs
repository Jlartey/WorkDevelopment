...
Dim totalCollectionYB, totalRefundYB, totalBalanceYB
...
grandTotalCollection = totalCollectionYB '+ totalCollectionAFC
grandTotalRefund = totalRefundYB '+ totalRefundAFC
grandTotalBalance = totalBalanceYB '+ totalBalanceAFC

response.Write "<h5><b>CASH COLLECTION SUMMARY BY FACILITY<b><h5> <br>"
response.Write "<div class='container'>"
response.Write "<div class='row'>"
response.Write "<div class='col-md-12'>"
YBReportTotals = generateReportYB()
response.Write "</div>"
...
'Sub generateReportYB()
Function generateReportYB()
    Set rst = CreateObject("ADODB.Recordset")
    response.Write "<h5>CASH COLLECTION SUMMARY BY Y&B Medicare</h5> "
...
sql = sql & "ORDER BY WorkingDay.WorkingDayName"
    ...
    With rst
        If Not .EOF And Not .BOF Then
            ...
            Do While Not .EOF
                ...
                totalCollectionYB = totalCollectionYB + ReceiptAmot
                
                totalRefundYB = totalRefundYB + PaidAmot
                totalBalanceYB = totalBalanceYB + bal
            ...
            response.Write "<td>" & FormatNumber(totalCollectionYB, 2, -1, 0, -1) & "</td>"
            response.Write "<td>" & FormatNumber(totalRefundYB, 2, -1, 0, -1) & "</td>"
            response.Write "<td>" & FormatNumber(totalBalanceYB, 2, -1, 0, -1) & "</td>"
            response.Write "</tr>"
        Else
   ...
   response.Write " </table>"
    ...
    generateReportYB = Array(totalCollectionYB, totalRefundYB, totalBalanceYB)
End Function
...
finalGrandTotal = YBReportTotals(0) '+ afcReportTotals(0)
finalGrandTotalRefund = YBReportTotals(1) '+ afcReportTotals(1)
finalGrandTotalBalance = YBReportTotals(2) '+ afcReportTotals(2)
