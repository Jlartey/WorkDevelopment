...
printlayoutName = "drugPurDashboard"
...
sql = sql & " FROM DrugPurOrder WHERE WorkingMonthID "& mth &" AND SupplierID "& sup &" ORDER BY  purchaseorderdate DESC  "
...
'                phref = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=Drug Purchase Dashboard&PositionForTableName=DrugPurOrder&DrugPurOrderID=" & purID
                 phref = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=" & server.URLEncode(printlayoutName) & "&PositionForTableName=DrugPurOrder&DrugPurOrderID=" & server.URLEncode(purID)
                ...
                ' Else
                '     response.write "                    <div class='df w100'><div class='p5 f1'><span class='datastat pnd'>Pharmacy HOD Approval Pending</span></div><div class='f1 df f-end'>"
                ...
                ' End If
                ''''''Uncomment
                'If Approved(purID, "DrugPurOrderPro-T001") Then
                    'response.write "                    <div class='p5'><span class='pr5 bold'>Approved by:</span>" & getUserAppv(purID, "DrugPurOrderPro-T001") & "</div>"
                'Else
                    'response.write "                    <div class='df w100'><div class='p5 f1'><span class='datastat pnd'>Pharmacy HOD Approval Pending</span></div><div class='f1 df f-end'>"
                    'sTb2 = "DrugPurOrderPro"
                    'by Mike
    ...
    With rst
        ...
        If rst.RecordCount > 0 Then
            ...
            Loop
                ...
                response.write "                 </div>"
                response.write "                </div></div>"
                If SupplyNotComplete(reqId) Then 'And Approved(reqId, "DrugPurOrderPro-T001") Then ''Uncomment
                    sTb2 = "IncomingDrug"
                    'by Mike
        ...
        Else
            ...
            sTb2 = "IncomingDrug"
            'If Approved(reqId, "DrugPurOrderPro-T001") Then
            'by Mike
                ' If HasAccessRight(uname, "frm" & sTb2, "New") Then
