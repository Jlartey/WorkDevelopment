...
response.write vbCrLf & "          const amountInput = document.getElementById('amount');"
...
response.write vbCrLf & "          } : null;"
response.write vbCrLf & "          const amount = amountInput.value;"
...
response.write vbCrLf & "                sponsorSelect.selectedIndex = 0;"
response.write vbCrLf & "                sponsorChoices.setChoiceByValue('');"
response.write vbCrLf & "                billMonthSelect.selectedIndex = 0;"
response.write vbCrLf & "                billMonthChoices.setChoiceByValue('');"
response.write vbCrLf & "                amountInput.value = '';"
...
response.write vbCrLf & "    <script>"
response.write vbCrLf & "      let sponsorChoices, billMonthChoices;  // Declare globally for reset access"
response.write vbCrLf & "      try {"
response.write vbCrLf & "        sponsorChoices = new Choices('#sponsors', {"
...
response.write vbCrLf & "        });"
response.write vbCrLf & "        billMonthChoices = new Choices('#billMonth', {"
response.write vbCrLf & "          searchEnabled: true,"
response.write vbCrLf & "          placeholderValue: 'Search',"
response.write vbCrLf & "          searchPlaceholderValue: 'Search',"
response.write vbCrLf & "          itemSelectText: '',"
