...
response.write vbCrLf & "                // Clear form fields"
response.write vbCrLf & "                sponsorSelect.selectedIndex = 0;"
response.write vbCrLf & "                sponsorChoices.setChoiceByValue('');  // Reset Choices.js"
response.write vbCrLf & "                billMonthSelect.selectedIndex = 0;"
response.write vbCrLf & "                billMonthChoices.setChoiceByValue('');  // Reset Choices.js"
response.write vbCrLf & "                amountInput.value = '';"
response.write vbCrLf & "                // Send message to parent to close modal and reload"
