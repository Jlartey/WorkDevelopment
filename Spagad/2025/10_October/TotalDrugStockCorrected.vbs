...
Sub dispTotalDrugStock()
    ...
    With rst
        ...
        If .recordCount > 0 Then
            ...
            response.write "<h1> DRUG STOCK LEVELS ACROSS THE DRUG STORES "
    ...
    For i = 0 To numStores - 1
        ...
        storeCols = storeCols & "COALESCE(SUM(CASE WHEN ds.DrugStoreID = '" & Replace(storeArray(0, i), "'", "''") & "' THEN ds.AvailableQty ELSE 0 END), 0) AS '" & storeArray(0, i) & "'"
    Next

    Set rst2 = CreateObject("ADODB.Recordset")

    sql = "SELECT d.DrugName, " & storeCols
