...
Dim medicalOutcome, periodStart, periodEnd, datePeriod
...
response.write "<div class='filters'>"
    ...
    response.write " <div>"
    response.write "        <button class='mybutton' type='button' onclick='updateUrl()'>Show Data</button> <br />"
    response.write " </div"
response.write "</div>"
