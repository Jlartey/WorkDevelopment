...
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
response.write "          <h1 id='mortality' style='font-size: 20px; display: flex; justify-content: center; align-items: center'>" & GetMortalityR & "</h1>"
response.write "          </a>"
response.write "        </div>"
' response.write ""
' response.write "        <div class=""card2"">"
...
Sub GetTotalStaff()
    ...
    sql = sql & "WHERE Staff.StaffStatusID = 'S001';"
