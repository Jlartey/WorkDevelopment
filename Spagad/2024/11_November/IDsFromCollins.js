        ...
        radios.forEach(el=>{
            if(el.checked){
                if(subCat.sub1.includes(el.getAttribute('name'))){
                    ...
                    document.querySelector('[id="RES004^^E000199Column2"]').value = ((((((sub1Score||1)-1)/8)*100) + ((((sub2Score||1)-1)/8)*100) +
                    ((((sub3Score||1)-1)/8)*100) + ((((sub4Score||1)-1)/8)*100) + ((((sub5Score||1)-1)/8)*100) + ((((sub6Score||1)-1)/8)*100) + ((((sub7Score||1)-1)/8)*100) + ((((sub8Score||1)-1)/8)*100) + ((((sub9Score||1)-1)/8)*100) + ((((sub10Score||1)-1)/8)*100) + ((((sub11Score||1)-1)/8)*100)
                        )/(12)).toFixed(2) ;
