...
With rstTblSql
  ...
  sql = "select sum(finalamt) as sm from ( "
      sql = sql & "select FinalAmt, returnqty from drugreturnitems where insuredPatientid='" & inspat & "' "
      sql = sql & " and workingyearid='" & mth & "' and workingMonthID>'MTH201408'"

      sql = sql & "union all select FinalAmt, returnqty from drugreturnitems2 where insuredPatientid='" & inspat & "' "
      sql = sql & " and workingyearid='" & mth & "' and workingMonthID>'MTH201408'"
...
With rst
  ...
  sql = "select sum(finalamt) as amt, avg(unitcost) as unicost  from ("
    sql = sql & "select labtestid, qty, unitcost, finalamt from investigation where insuredPatientid='" & inspat & "' "
    sql = sql & " and workingyearid='" & mth & "' and workingMonthID>'MTH201408' and TestCategoryID<>'B19'"
    sql = sql & "union all "
    sql = sql & "select labtestid, qty, unitcost, finalamt from investigation2 where insuredPatientid='" & inspat & "' "
    sql = sql & " and workingyearid='" & mth & "' and workingMonthID>'MTH201408' and TestCategoryID<>'B19'"
  sql = sql & ") as t"
...
With rst
  ...
  sql = "select sum(finalamt) as amt, avg(unitcost) as unicost from ("
    sql = sql & "select drugid, qty, unitcost, finalamt from drugsaleitems where insuredPatientid='" & inspat & "' "
    sql = sql & " and workingyearid='" & mth & "' and workingMonthID>'MTH201408' "
    sql = sql & " union all "
    sql = sql & "select drugid, DispenseAmt1 as qty, unitcost, dispenseAmt2 as finalamt from drugsaleitems2 where insuredPatientid='" & inspat & "' "
    sql = sql & " and workingyearid='" & mth & "' and workingMonthID>'MTH201408' "
  sql = sql & ") as t "
...
Dim insPrn, iDep, rst2, inspat, stfInsPat
...
stfInsPat = Trim(GetStaffBillAccount(stf, insr))
sql = "select distinct InsSchemeModeid,InsuredPrincipalID,InitialDependantID from Visitation "
sql = sql & " where workingYearid='" & mth & "' and WorkingMonthID>'MTH201408' and InsuredPrincipalID='" & stfInsPat & "'"
...
response.write "<td colspan=""2"" valign=""top"" align=""left"" width=""100%"" style=""" & cellSty & """>"
  response.write "<table border=""0"" width=""100%"" cellspacing=""1"" cellpadding=""0"" style=""font-size: 7pt; font-family: Arial"">"
      ...
      response.write "<td align=""center"">"
      response.write "CLINIC - ADENTA<br>"
      response.write "ADENTA SHOPPING CENTRE <br>"
      response.write "ADENTA HOUSING<br>"
      response.write "ADENTA, ACCRA<br>"
      ...
      response.write "<td align=""center"">"
      response.write "CLINIC - DANSOMAN<br>"
      response.write "DANSOMAN, ACCRA<br>"
      response.write "TEL:0302761976-7<br><br>"
      response.write "</td>"
      ...
      response.write "<td align=""center"">"
      response.write "CLINIC - PENSION HOUSE <br>"
      ...
      response.write "<td align=""center"">"
      response.write "CLINIC - SAKUMONO <br>"
      response.write "OPPOSITE TENNIS CLUB <br>"
      response.write "SAKUMONO, ACCRA<br>"
...
End Function
Function GetStaffBillAccount(stf, insr)
  Dim rst, sql, ot, tot, amt
  Set rst = CreateObject("ADODB.Recordset")
  ot = ""
 
  With rst
    sql = "select insuredPatientID from insuredPatient where sponsorid='" & insr & "' and Patientid='" & stf & "'"
    .open qryPro.FltQry(sql), conn, 3, 4
    If .RecordCount > 0 Then
      .MoveFirst
      ot = .fields("insuredPatientID")
    End If
    .Close
  End With
  GetStaffBillAccount = ot
  Set rst = Nothing
End Function
  'GetSponsorBillAmt
...
Sub DisplayHeader()
  ...
  response.write "<td>"
    ...
    response.write "</tr>"
    response.write "<tr>"
    response.write "<td align=""center"" style=""font-size: 14pt"" colspan=""6"">THE HOSPITAL</td>"
    response.write "</tr>"
    response.write "<tr>"
    ...
    response.write "</tr>"
     ...
     response.write "<tr>"
    response.write "<td align=""center"" style=""font-size: 10pt"" colspan=""6"">FAX:&nbsp;+233-0302-777790,&nbsp;&nbsp;&nbsp;&nbsp;WEB:&nbsp;thehospital.com, EMAIL:&nbsp;info@thehospital.com</td>"
    response.write "</tr>"
    response.write "</table>"
...
Dim mth, wkDy, prtFlt
Dim clmCon, clmDrg, clmLab, clmXrSc, clmAdm, clmPro, clmOth, clmTot, stf
Dim clmEye, clmEnt, clmDent, clmPhys, spDet, modCnt, pgCnt, modPos, gInsNo

server.scripttimeout = 1800

prtFlt = request.querystring("PrintFilter0")
mth = request.querystring("PrintFilter0")
stf = request.querystring("PrintFilter1")
'CoverLetter
'response.write "<tr>"
'response.write "<td align=""left"">"
...
response.write (GetRecordField("SponsorName")) & " [" & UCase(stf) & " : " & GetComboName("Patient", stf) & " Staff Benefit Utilization for " & GetComboName("WorkingYear", mth) & "]</td>"
response.write "</tr>"
response.write "<tr>"
response.write "<td align=""center""><hr color=""#999999"" size=""1""></td>"
response.write "</tr>"
