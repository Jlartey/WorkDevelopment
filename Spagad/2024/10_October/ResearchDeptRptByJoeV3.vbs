...
' Call the dropdown to select report
dispOption

response.write "<div id='srsReport' style='display:none;'>"
displaySRS ' SRS report wrapped in a div
response.write "</div>"

response.write "<div id='hoosReport' style='display:none;'>"
displayHOOS ' HOOS report wrapped in a div
response.write "</div>"
...
' JavaScript for showing/hiding reports based on dropdown selection
