...
' Function getHOOS_Score01(EMRRequestID)
'   Dim sql, rst
'   Set rst = CreateObject("ADODB.RecordSet")
...
'     .open qryPro.FltQry(sql), conn, 3, 4
'       If .RecordCount > 0 Then
'         getHOOS_ScoreDivided = FormatNumber(.fields("userScore") / .fields("totalScore"))
'         getHOOS_Score = "" & .fields("userScore") & " / " & .fields("totalScore") & " = " & getHOOS_ScoreDivided & ""
' '        getHOOS_Score = "check your fields lol"
'       End If
'     .Close
'   End With
' End Function