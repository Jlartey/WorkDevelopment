      ...
      .open qryPro.FltQry(sql), conn, 3, 4
          If .RecordCount > 0 Then
              ...
              Do While Not .EOF
                ...
                Dim url
                url = "wpgPrtPrintLayoutAll.asp?PositionForTableName=WorkingDay&WorkingDayID=DAY20160401&PrintLayoutName=EMRSelector&CompTableKeyID=EMRComponentID&VisitationID=" & .fields("visitationID") & "&EMRDataID=RES018&InvestDays=&ModuleManagerName=Research&PositionForCtxTableName=Visitation&SectionType=EMR&WorkFlowNav=POP"
