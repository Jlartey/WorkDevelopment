...
'          response.write "</tr>"
          ...
          Do While Not .EOF And recCnt < CInt(recPerPg)
            ...
            response.write "<td align=""right""> <label for=""options"">Choose an option:</label><select id=""options"" name=""options""><option value=""option1"">Option 1</option><option value=""option2"">Option 2</option></select></td>"
            response.write "<td align=""right""></td>"
