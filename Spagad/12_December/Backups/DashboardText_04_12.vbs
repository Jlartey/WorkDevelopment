...
'@By J. L.
Dim medics, nonMedics, totalStaff
GetTotalStaff
...
Dim hrf1, hrf2, hrf3, hrf4, hrf5, hrf6, hrf7, hrf8, hrf9, hrf10, hrf11
Dim hrf12, hrf13, hrf14, hrf15, hrf16, hrf17, hrf18, hfr19, hfr20, hfr21
Dim noShow
...
GetTotMedStaff = GetTotalMedStaff()
MortalityRate = GetMortalityR()
bedOccupancy = GetBedOcc()
totalAdDischarge = totalDischarge()
totalCancelledApp = GetTotalCancelled()
pharmWaitAvg = GetPharmWaitTime()
opdWaitTimeAvg = GetOpdAvgWaitTime()
consultTimeAVG = GetConsultTimeAVG()

'staffPat = GetTotMedStaff / totalVisit
staffPat = medics / totalVisit
'Patstaff = totalVisit / GetTotMedStaff
Patstaff = totalVisit / medics
noShow = GetTotalCancelled / GetTotalAppointments
response.write GetTotalAppointments
...
hrf14 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=labsummary&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
...
hrf19 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=ReAdmissionRate&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
hrf20 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=totalVisitGrouped&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
hrf21 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=totalAdmittedPatients&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
hrf22 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=cancelledAppointments&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
hrf23 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=RegisteredPatientDetails&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
hrf24 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=DeadPatients&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
hrf25 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=rptPatientWaitingTime&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
hrf26 = "wpgPrtPrintLayoutAll.asp?PrintLayoutName=TotalDischarge&PositionForTableName=WorkingDay&WorkingDayID=&printfilter=" & periodStart & "&printfilter1=" & periodEnd
...
response.write "            <span class=""material-icons-outlined"">groups</span> FOH KPIs"
response.write "          </div>"
...
response.write "          <a href='" & hrf23 & "' target='_blank'>"
response.write "          <div class=""card-inner"">"
response.write "            <h3>Total Registered Patients</h3>"
...
response.write ""
response.write "        <div class=""card"">"
response.write "          <a href='" & hrf21 & "' target='_blank'>"
response.write "            <div class=""card-inner"">"
...
response.write "        </div>"
response.write ""
response.write "        <div class=""card"" style=""height: 185px;"">"
response.write "         <a href='" & hrf20 & "' target='_blank'>"
response.write "          <div class=""card-inner"">"
...
response.write "          <p style='font-size: 25px;  font-weight: bold'> " & totalStaff & "</p>"

response.write "          <div class=""card-inner"">"
    response.write "          <p style='font-size: 16px; font-weight: bold'>Medics: " & medics & "</p>"
    response.write "          <p style='font-size: 16px; font-weight: bold'>Non-Medics: " & nonMedics & "</p>"
response.write "          </div>"
response.write "        </div>"
response.write ""
...
response.write "          <div class=""card-inner"">"
response.write "            <h3>Staff-To-Visit Ratio</h3>"
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
...
response.write "        <div class=""card2"">"
response.write "          <div class=""card-inner"">"
response.write "            <h3>Visit-To-Staff Ratio</h3>"
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
...
response.write "        <div class=""card2"">"
response.write "          <a href='" & hrf24 & "' target='_blank'>"
response.write "          <div class=""card-inner"">"
response.write "            <h3>Total Deaths</h3>"
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
response.write "          <h1>" & GetMortalityR & "</h1>"
response.write "          </a>"
response.write "        </div>"
' response.write ""
' response.write "        <div class=""card2"">"
...
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
response.write "          <h1> " & (pharmWaitAvg) & " Hrs</h1>"
response.write "        </div>"

response.write "        <div class=""card3"">"
response.write "        <a href='" & hrf25 & "' target='_blank'>"
response.write "          <div class=""card-inner"">"
response.write "            <h3>OPD Wait Time Between Visit and Consult(AVG)</h3>"
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
response.write "          <h1>" & Round(opdWaitTimeAvg, 2) & " Hours</h1>"
response.write "        </a>"
response.write "        </div>"

response.write "        <div class=""card3"">"
response.write "          <div class=""card-inner"">"
response.write "            <h3>AVG Time Spent During Consultationg</h3>"
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
response.write "          <h1>" & Round(consultTimeAVG, 2) & " Hours</h1>"
response.write "        </div>"
...
response.write "      <div class=""main-cards"">"
response.write "        <a href='" & hrf26 & "' target='_blank'>"
response.write "        <div class=""card4"">"
response.write "          <div class=""card-inner"">"
response.write "            <h3>Total Discharges</h3>"
response.write "            <span class=""material-icons-outlined"">groups</span>"
response.write "          </div>"
response.write "          <h1>" & totalAdDischarge & "</h1>"
response.write "        </div>"
response.write "        </a>"
response.write "      </div>"
...
response.write "            <a href='" & hrf19 & "' target='_blank'>View More</a>"
response.write "          </button>"
response.write "        </div>"
' response.write "      <div class=""charts"">"
response.write "        <div class=""charts-card"">"
response.write "          <h2 class=""chart-title"">Total Admission vs FallRiskAssessment, Pain Scale, BraidingScale and SBar</h2>"
response.write "            <canvas id=""AdmissionVsForms"" width=""300"" height=""300""></canvas>"
response.write "          <button type = ""button"" class = ""btn3""> "
response.write "            <a href='" & hrf24 & "' target='_blank'>View More</a>"
response.write "          </button>"
response.write "        </div>"
response.write "        <div class=""charts-card"">"
...
response.write "        </div>"
response.write "        <div class=""charts-card"">"
response.write "          <h2 class=""chart-title"">Mode of Payment</h2>"
response.write "            <canvas id=""mode-of-payment"" width=""300"" height=""300""></canvas>"
' response.write "          <button type = ""button"" class = ""btn3""> "
' response.write "            <a href='" & hrf6 & "' target='_blank'>View More</a>"
' response.write "          </button>"
response.write "        </div>"
...
'response.write "        </div>"
response.write "        <div class=""charts-card"">"
response.write "          <h2 class=""chart-title"">TOP 10 Lab/Radiology Average Waiting Time</h2>"
...
response.write "        </div>"
response.write "        <div class=""charts-card"">"
response.write "          <h2 class=""chart-title"">TOP 10 Diagnosis</h2>"
response.write "            <canvas id=""topDiagnosis"" width=""300"" height=""300""></canvas>"
response.write "          <button type = ""button"" class = ""btn3""> "
response.write "            <a href='" & hrf15 & "' target='_blank'>View More</a>"
response.write "          </button>"
response.write "        </div>"
response.write "        <div class=""charts-card"">"
response.write "          <h2 class=""chart-title"">TOP 10 Surgeries</h2>"
response.write "            <canvas id=""topSurgeries"" width=""300"" height=""300""></canvas>"
response.write "          <button type = ""button"" class = ""btn3""> "
response.write "            <a href='" & hrf15 & "' target='_blank'>View More</a>"
response.write "          </button>"
response.write "        </div>"
...
'response.write "    console.log('wossop');"
...
Sub StyleCSS()
    ...
    response.write ""
    response.write ""
    response.write ".card4:first-child {"
    response.write "  background-color:#2e7d32 ;"
    response.write "}"
    response.write ""
    response.write ".card4:nth-child(2) {"
    response.write "  background-color:#2962ff;"
    response.write "}"
    response.write ""
    response.write ".card4:nth-child(4) {"
    response.write "  background-color:  #ff6d00;"
    response.write "}"
    response.write ""
    response.write ".card4:nth-child(3) {"
    response.write "  background-color:  #d50000;"
    response.write "}"
    response.write ""
...
Sub AvgWaitingTime()
 ...
 Dim sql, rst
    ...
    ' sql = sql & " Where"
    ' sql = sql & " Investigation.testContainerid = 'DPT005'"
    ...
    ' sql = sql & " Where "
    ' sql = sql & "   Investigation2.testContainerID = 'DPT005'"
    ...
    sql = "WITH patWaitingTime AS ( "
    sql = sql & " SELECT Investigation.VisitationID, labrequest.LabRequestID "
    sql = sql & " , Investigation.LabTestID, LabRequest.requestdate AS RequestDate "
    sql = sql & " , Investigation.requestdate1 AS ReadyDate FROM Investigation "
    sql = sql & " JOIN LabRequest ON LabRequest.LabRequestID = Investigation.LabRequestID  "
    sql = sql & " WHERE Investigation.RequestStatusID = 'RRD002'  "
    ' sql = sql & " AND Investigation.TestContainerID = 'DPT005' "
    sql = sql & " AND Investigation.RequestDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "' "
    sql = sql & " UNION  "
    sql = sql & " SELECT Investigation2.VisitationID, labrequest.LabRequestID "
    sql = sql & " , Investigation2.LabTestID, LabRequest.requestdate AS RequestDate "
    sql = sql & " , Investigation2.requestdate1 AS ReadyDate FROM Investigation2 "
    sql = sql & " JOIN LabRequest ON LabRequest.LabRequestID = Investigation2.LabRequestID "
    sql = sql & " WHERE Investigation2.RequestStatusID = 'RRD002' "
    ' sql = sql & " AND Investigation.TestContainerID = 'DPT005' "
    sql = sql & " AND Investigation2.RequestDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "' "
    sql = sql & " ) SELECT TOP 10 LabtestID, ROUND(AVG(CAST(DATEDIFF(Hour, RequestDate, ReadyDate) AS FLOAT)), 2) AS AvgTimeDifferenceInHours "
    sql = sql & " FROM patWaitingTime "
    sql = sql & " GROUP BY LabTestID "
    sql = sql & " ORDER BY AvgTimeDifferenceInHours DESC  "
    ...
    If rst.RecordCount > 0 Then
        ...
        Do While Not rst.EOF
            ...
            departmentsArray = departmentsArray & "'" & GetComboName("LabTest", rst.fields("LabtestID")) & "'"
            stayArray = stayArray & rst.fields("AvgTimeDifferenceInHours")
...
Sub GetTopDiagnosisJS()

 Dim sql, rst
    
    Set rst = CreateObject("ADODB.recordset")
    
    sql = " SELECT TOP 10 diseaseid, COUNT(DiseaseID) AS cnt"
    sql = sql & " FROM diagnosis"
    If (periodStart <> "") And (periodEnd <> "") Then
        sql = sql & " WHERE maindate1 BETWEEN '" & periodStart & "' AND '" & periodEnd & "'"
    End If
    sql = sql & " GROUP BY diseaseid"
    ...
    Do While Not rst.EOF
        ...
        appointArray = appointArray & "'" & GetComboName("Disease", rst.fields("diseaseid")) & "'"
        totalpArray = totalpArray & rst.fields("cnt")
    ...
    response.write "    var total = values.reduce((acc, val) => acc + val, 0);"
    response.write "    var percentages = values.map(val => ((val / total) * 100).toFixed(2) + '%');"
    response.write "    var ctx = document.getElementById('topDiagnosis').getContext('2d');"
    response.write "    var pieChart = new Chart(ctx, {"
    response.write "      type: 'bar',"
    response.write "      data: {"
    response.write "        labels: labels,"
...
Sub GettopSurgeriesJS()

 Dim sql, rst
    
    Set rst = CreateObject("ADODB.recordset")
    
    sql = "WITH SurgeryList AS ( "
    sql = sql & "     SELECT  "
    sql = sql & "         LTRIM(RTRIM(REPLACE(LEFT(CAST(COLUMN2 AS NVARCHAR(MAX)), CHARINDEX('||', CAST(COLUMN2 AS NVARCHAR(MAX)) + '||') - 1), '|', ''))) AS Surgery, "
    sql = sql & "         CAST(STUFF(CAST(COLUMN2 AS NVARCHAR(MAX)), 1, CHARINDEX('||', CAST(COLUMN2 AS NVARCHAR(MAX)) + '||'), '') AS NVARCHAR(MAX)) AS RemainingSurgeries "
    sql = sql & "     FROM EMRResults "
    sql = sql & "     WHERE emrdataid = 'FOH013' AND EMRComponentID = 'FOH013001.9' AND CAST(COLUMN2 AS NVARCHAR(MAX)) <> '' "
    sql = sql & "     UNION ALL     "
    sql = sql & "     SELECT  "
    sql = sql & "         LTRIM(RTRIM(REPLACE(LEFT(RemainingSurgeries, CHARINDEX('||', RemainingSurgeries + '||') - 1), '|', ''))) AS Surgery, "
    sql = sql & "         CAST(STUFF(RemainingSurgeries, 1, CHARINDEX('||', RemainingSurgeries + '||'), '') AS NVARCHAR(MAX)) AS RemainingSurgeries "
    sql = sql & "     FROM SurgeryList "
    sql = sql & "     WHERE RemainingSurgeries <> '' "
    sql = sql & " ) "
    sql = sql & " SELECT TOP 10 Surgery, COUNT(*) AS SurgeryCount "
    sql = sql & " FROM SurgeryList "
    sql = sql & " WHERE Surgery <> ''  "
    sql = sql & " GROUP BY Surgery "
    sql = sql & " ORDER BY SurgeryCount DESC "
    ...
    Do While Not rst.EOF
        ...
        appointArray = appointArray & "'" & GetComboName("Treatment", rst.fields("Surgery")) & "'"
        totalpArray = totalpArray & rst.fields("SurgeryCount")
    ...
    response.write "    var total = values.reduce((acc, val) => acc + val, 0);"
    response.write "    var percentages = values.map(val => ((val / total) * 100).toFixed(2) + '%');"
    response.write "    var ctx = document.getElementById('topSurgeries').getContext('2d');"
    response.write "    var pieChart = new Chart(ctx, {"
    response.write "      type: 'bar',"
    response.write "      data: {"
    response.write "        labels: labels,"
...
Sub AdmissionVsForms()

 Dim sql, rst
    
    Set rst = CreateObject("ADODB.recordset")
    
    sql = "SELECT EMRRequestItems.EMRDataID, EMRData.EMRDataName, COUNT(Admission.AdmissionID) AS cnt "
    sql = sql & " FROM Admission "
    sql = sql & " JOIN EMRRequest ON EMRRequest.VisitationID = Admission.VisitationID "
    sql = sql & " JOIN EMRRequestItems ON EMRRequestItems.EMRRequestID = EMRRequest.EMRRequestID "
    sql = sql & " JOIN EMRData ON EMRData.EMRDataID = EMRRequestItems.EMRDataID "
    sql = sql & " WHERE EMRRequestItems.EMRDataID IN ('NUR006', 'NUR011', 'TH054', 'E000038', 'PT0017') "
    sql = sql & " AND Admission.admissionDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "' "
    sql = sql & " GROUP BY EMRRequestItems.EMRDataID, EMRData.EMRDataName "
    ...
    If rst.RecordCount > 0 Then
        ...
        Do While Not rst.EOF
            ...
            SuppArray = SuppArray & "'" & rst.fields("EMRDataName") & "'"
            totalAmtArray = totalAmtArray & rst.fields("cnt")
        ...
        response.write "    var total = values.reduce((acc, val) => acc + val, 0);"
        response.write "    var percentages = values.map(val => ((val / total) * 100).toFixed(2) + '%');"
        response.write "    var ctx = document.getElementById('AdmissionVsForms').getContext('2d');"
        response.write "    var pieChart = new Chart(ctx, {"
        response.write "      type: 'bar',"
        response.write "      data: {"
        response.write "        labels: labels,"
...
Sub modeOfPayment()
 ...
 Dim sql, rst
    ...
    sql = " SELECT PaymentMode.PaymentModeName, COUNT(Receipt.PaymentModeID) AS [PaymentModeCnt]"
    sql = sql & " FROM Receipt"
    sql = sql & " INNER JOIN PaymentMode ON Receipt.PaymentModeID = PaymentMode.PaymentModeID"
    If (periodStart <> "") And (periodEnd <> "") Then
        sql = sql & " WHERE Receipt.ReceiptDate BETWEEN '" & periodStart & "' AND  '" & periodEnd & "'"
    End If
    sql = sql & " GROUP BY PaymentMode.PaymentModeName"
    ...
    If rst.RecordCount > 0 Then
        ...
        Do While Not rst.EOF
            ...
            SuppArray = SuppArray & "'" & rst.fields("PaymentModeName") & "'"
            totalAmtArray = totalAmtArray & rst.fields("PaymentModeCnt")
        ...
        response.write "    var total = values.reduce((acc, val) => acc + val, 0);"
        response.write "    var percentages = values.map(val => ((val / total) * 100).toFixed(2) + '%');"
        response.write "    var ctx = document.getElementById('mode-of-payment').getContext('2d');"
        response.write "    var pieChart = new Chart(ctx, {"
        response.write "      type: 'bar',"
        response.write "      data: {"
        response.write "        labels: labels,"
        response.write "        datasets: [{"
        response.write "          data: values,"
        response.write "          backgroundColor: ['#2962ff', '#2962ff', '#2962ff', '#2962ff', '#2962ff'],"
        response.write "        }]"
        response.write "      },"
        response.write "      options: {"
        response.write "        scales: {"
...
Sub mostSoldDrugs()
 ...
 Dim sql, rst
    ...
    sql = sql & "     WHERE DrugSaleItems.jobscheduleID = 's22' "
    ...
    sql = sql & "     WHERE DrugSaleItems2.jobscheduleID = 's22' "
...
Function GetTotalPatAd()
    ...
    sql = "SELECT COUNT(DISTINCT PatientID) as totPatAd FROM Admission"
    If (periodStart <> "") And (periodEnd <> "") Then
      sql = sql & " WHERE AdmissionDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "'"
    End If
...
Sub GetTotalStaff()
    ...
    sql = "SELECT "
    sql = sql & "COUNT(DISTINCT CASE "
    sql = sql & "WHEN SystemUser.JobScheduleID LIKE 'W00%' "
    sql = sql & "OR SystemUser.JobScheduleID LIKE 'M030%' "
    sql = sql & "OR SystemUser.JobScheduleID = 'S13' "
    sql = sql & "OR SystemUser.JobScheduleID = 'S19' "
    sql = sql & "THEN Staff.StaffID END) AS medics, "
    
    sql = sql & "COUNT(DISTINCT CASE "
    sql = sql & "WHEN NOT (SystemUser.JobScheduleID LIKE 'W00%' "
    sql = sql & "OR SystemUser.JobScheduleID LIKE 'M030%' "
    sql = sql & "OR SystemUser.JobScheduleID = 'S13' "
    sql = sql & "OR SystemUser.JobScheduleID = 'S19') "
    sql = sql & "THEN Staff.StaffID END) AS non_medics "
    
    sql = sql & "FROM Staff "
    sql = sql & "JOIN SystemUser ON SystemUser.StaffID = Staff.StaffID "
    sql = sql & "WHERE Staff.StaffStatusID = 'S001' AND Staff.staffid LIKE 'FOH%';"


    rstPat.open qryPro.FltQry(sql), conn, 3, 4
    If Not rstPat.EOF Then
        medics = rstPat.fields("medics")
        nonMedics = rstPat.fields("non_medics")
    End If
    rstPat.Close
    
    totalStaff = medics + nonMedics
    'GetTotalStaff = finalNum
End Sub

Function GetTotalMedStaff()
    Dim rst, sql, finalNum
    
    Set rst = CreateObject("ADODB.recordset")
    
    sql = "SELECT COUNT(DISTINCT SystemUserID) AS totMedStaff FROM SystemUser"
    sql = sql & " JOIN Staff ON Staff.StaffID = SystemUser.StaffID"
    sql = sql & " WHERE 1=1"
    sql = sql & " AND "
    sql = sql & " (JobScheduleID LIKE '%M03%' OR JobScheduleID LIKE '%S19%' OR "
    sql = sql & " JobScheduleID LIKE '%S13%' OR JobScheduleID LIKE '%W00%' OR "
    sql = sql & " JobScheduleID LIKE '%M03%'"
    sql = sql & " )"
    sql = sql & " AND UserStatusID = 'UST001' AND Staffstatusid = 's001'"
    sql = sql & " AND SystemUserID <> JobScheduleID"

    rst.open qryPro.FltQry(sql), conn, 3, 4
    If Not rst.EOF Then
        finalNum = rst.fields("totMedStaff")
    End If
    rst.Close
    GetTotalMedStaff = finalNum
End Function
...
Function GetTotalAppointments()
    Dim rst, sql, totalAppointments
    
    Set rst = CreateObject("ADODB.recordset")
    
    sql = "SELECT  COUNT(*) appointments FROM Appointment "
    
    If (periodStart <> "") And (periodEnd <> "") Then
       sql = sql & "WHERE convert(date, AppointDate) BETWEEN '" & periodStart & "' AND '" & periodEnd & "'"
    End If
    
    rst.open qryPro.FltQry(sql), conn, 3, 4
    
    If Not rst.EOF Then
        totalAppointments = rst.fields("appointments")
    End If
    rst.Close
    
    GetTotalAppointments = totalAppointments
End Function
...
'    sql = " SELECT  "
'    sql = sql & "    COUNT(DISTINCT CASE WHEN Admission.AdmissionID IS NOT NULL THEN Visitation.VisitationID END) AS InPatient, "
'    sql = sql & "    COUNT(DISTINCT CASE WHEN Admission.AdmissionID IS NULL THEN Visitation.VisitationID END) AS OutPatient "
'    sql = sql & "FROM Visitation "
'    sql = sql & "LEFT JOIN Admission ON Admission.VisitationID = Visitation.VisitationID "
'    sql = sql & "WHERE Visitation.MedicalOutcomeID = 'M002' "
'    sql = sql & "AND Visitation.VisitDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "'"
    
    sql = "SELECT COUNT( DISTINCT EMRRequest.PatientID) [Dead Patients] "
    sql = sql & "From EMRResults Join EMRRequest "
    sql = sql & "ON EMRRequest.EMRRequestID = EMRResults.EMRRequestID "
    sql = sql & "WHERE EMRResults.emrdataid = 'TH080' "
    sql = sql & "AND cast(EMRResults.Column2 AS NVARCHAR(MAX)) = 'M002' "
    sql = sql & "AND convert(date, EMRRequest.EMRDate) BETWEEN '" & periodStart & "' AND '" & periodEnd & "' "
    
'    sql = "SELECT COUNT(PatientID) Deaths FROM Visitation WHERE MedicalOutcomeID = 'm002'"
'    If (periodStart <> "") And (periodEnd <> "") Then
...
'    End If
    ...
    rstPat.open qryPro.FltQry(sql), conn, 3, 4
    If Not rstPat.EOF Then
'            finalNum = rstPat.fields("Deaths")
            finalNum = " " & rstPat.fields("Dead Patients") & " "
            'finalNum = "Inpatients: " & rstPat.fields("InPatient") & vbCrLf & "Outpatients: " & rstPat.fields("OutPatient")
...
Function totalDischarge()
    Dim rstPat, sql
    
    Set rstPat = CreateObject("ADODB.recordset")
    
    sql = "SELECT count(Admission.AdmissionID) cnt From Admission "
    sql = sql & "JOIN Ward ON Ward.WardID = Admission.WardID "
    sql = sql & "JOIN Patient ON Patient.PatientID = Admission.PatientID "
    sql = sql & "WHERE Admission.DischargeDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "' "
    sql = sql & "AND (Admission.TransProcessValID = 'AdmissionPro-T004' OR Admission.TransProcessValID = 'AdmissionPro-T005' "
    sql = sql & "OR Admission.AdmissionStatusID = 'A002')"
           
    rstPat.open qryPro.FltQry(sql), conn, 3, 4
    If Not rstPat.EOF Then
            finalNum = rstPat.fields("cnt")
    End If
    rstPat.Close
    
    totalDischarge = finalNum
End Function
...
Function GetPharmWaitTime()
    ...
    sql = " SELECT  AVG(DATEDIFF(HOUR, Prescription.PrescriptionDate, DispenseDate)) AS avg_wait_time FROM DrugSaleItems2"
...
Function GetOpdAvgWaitTime()
    ...
    Set rstPat = CreateObject("ADODB.recordset")
        ...
        sql = " WITH VisitLogs AS ("
        sql = sql & " SELECT TOP 10 v.visitationID, v.visitdate, s.logdate"
        sql = sql & " FROM Visitation v"
        sql = sql & " JOIN SystemLog s"
        sql = sql & " ON v.visitationID = s.keyvalue"
        sql = sql & " AND s.keyPrefix = 'BEGIN_CONSULTATION'"
        sql = sql & " WHERE VisitDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "'"
        sql = sql & " )"
        sql = sql & " SELECT AVG(DATEDIFF(hour, visitdate, logdate)) AS AvgTimeDifferenceInMinutes"
        sql = sql & " FROM VisitLogs;"
        
    rstPat.open qryPro.FltQry(sql), conn, 3, 4
    If Not rstPat.EOF Then
            finalNum = rstPat.fields("AvgTimeDifferenceInMinutes")
    End If
    rstPat.Close
...
Function GetConsultTimeAVG()
    Dim rstPat, sql, finalAmt
    
    Set rstPat = CreateObject("ADODB.recordset")
    
        sql = " WITH ConsultationPairs AS ( "
        sql = sql & "   SELECT  "
        sql = sql & "       keyvalue, "
        sql = sql & "       MAX(CASE WHEN keyPrefix = 'BEGIN_CONSULTATION' THEN logdate END) AS BeginConsultationDate, "
        sql = sql & "       MAX(CASE WHEN keyPrefix = 'END_CONSULTATION' THEN logdate END) AS EndConsultationDate "
        sql = sql & "   FROM SystemLog "
        sql = sql & "   WHERE keyPrefix IN ('BEGIN_CONSULTATION', 'END_CONSULTATION') "
        sql = sql & "   AND LogDate BETWEEN '" & periodStart & "' AND '" & periodEnd & "'"
        sql = sql & "   GROUP BY keyvalue "
        sql = sql & " ) "
        sql = sql & " SELECT  "
        sql = sql & "   AVG(DATEDIFF(MINUTE, BeginConsultationDate, EndConsultationDate))/60 AS AvgTimeDifferenceInMinutes "
        sql = sql & " FROM ConsultationPairs "
        sql = sql & " WHERE BeginConsultationDate IS NOT NULL AND EndConsultationDate IS NOT NULL "
