...
AddCSSS
Dim sql, sql1, rst, rst1, datePeriod, cnt, vst, sponsor, gen, spclst, spclstTpe, spclstGrp, vstTpe, specialist, whcls, WorkingMonthID
...
'    sql = "SELECT * FROM " & strTable & " "
    sql = "SELECT EMRDataID, EMRDataName FROM EMRData WHERE EMRDataID IN ('RES004', 'RES017', 'RES018') ORDER BY EMRDataName ASC"
