...
Sub DatePicker()
    ...
    response.write "        <div class='date-group'> "
    response.write "            <label for='from'>From</label> "
    response.write "            <input type='date' name='from' id='from' class='styled-input'> "
    response.write "        </div> "
    response.write "        <div class='date-group'> "
    response.write "            <label for='to'>To</label> "
    response.write "            <input type='date' name='to' id='to' class='styled-input'> "
    response.write "        </div> "
    response.write "        <div class='button-group'> "
    response.write "            <button type='button' class='styled-button' onclick='updateUrl()'>Update</button> "
    response.write "        </div>    "
    response.write "    </div> "
    response.write "</form> "

    ' Add the script for URL update logic
    ...
    response.write "    } "
    response.write "    .styled-input:focus { "
    response.write "        outline: none; "
    response.write "        border-color: #007bff; "
    response.write "        box-shadow: 0 0 5px rgba(0, 123, 255, 0.5); "
    response.write "    } "
    response.write "    .button-group { "
    response.write "        display: flex; "
    ...
    response.write "        transition: background-color 0.3s ease; "
    response.write "        margin-top: 17px;"
    response.write "    } "
...
Sub DatePicker01()
    ...
    response.write "        </div> "
    response.write "        <div> "
    response.write "            <button type='button' onclick='updateUrl()'>Update</button> "
    response.write "        </div>    "
    response.write "    </div> "
    response.write "</form> "
    response.write "<script> "
    ...
    response.write "        const fromDate = document.getElementById('from').value; "
    response.write "        const toDate = document.getElementById('to').value; "
'    response.write "        const baseUrl = 'http://172.2.2.33/rmchms01/wpgPrtPrintLayoutAll.asp'; "
    response.write "        const baseUrl = 'http://172.2.2.33/hms/wpgPrtPrintLayoutAll.asp'; "
    response.write "        const params = new URLSearchParams({ "
    response.write "            PrintLayoutName: 'DispResearchRpt', "
    response.write "            PositionForTableName: 'WorkingDay', "
