  ...
  function L() {
    for (var e of p.children)
      e.addEventListener('click', (e) => {
        !1 === l.find((t) => t.value == e.target.dataset.value).selected
          ? ((l.find((t) => t.value == e.target.dataset.value).selected = !0),
            (c.value = null),
            f(),
            E())
          : ((l.find((t) => t.value == e.target.dataset.value).selected = !1),
            (c.value = null),
            f(),
            E(),
  ...
  (n = document.getElementById(e)),
    ...
    u.addEventListener('click', () => {
      v.classList.contains('hidden')
        ? (f(), L(), v.classList.remove('hidden'), c.focus())
    ...
    window.addEventListener('click', (e) => {
      a.contains(e.target) ||
        ...
        'input_checkbox' !== e.target.getAttribute('class')
          ? v.classList.add('hidden')
          : L());
    });
}
