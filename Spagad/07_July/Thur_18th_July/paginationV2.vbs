...
Dim periodStart, periodEnd, datePeriod, selectedWardIDs, selectedVisitTypeIDs, idsArr, idsArr2, formattedIDs, formattedIDs2, id, id2, dateArr
'Dim sql, sql2
...
' Output dropdown
    ...
    response.write "<div>"
    response.write "        <label for='visitType' class='font-style'>Select VisitType:</label><br>"
