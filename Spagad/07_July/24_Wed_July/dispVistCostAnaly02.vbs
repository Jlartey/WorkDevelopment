...
response.write "<div id='quarterlyTable' class='tab-content'>"
response.write "  <div class='chart-container'>"
...
Sub quarterlyVisitCostAnalysis()
    ...
    If rst.RecordCount > 0 Then
        ...
        Do While Not rst.EOF
            jsonData2 = jsonData2 & "{"
            jsonData2 = jsonData2 & """counter"":""" & counter & ""","
            jsonData2 = jsonData2 & """VisitYear"":""" & CStr(rst.Fields("VisitYear").Value) & ""","
            jsonData2 = jsonData2 & """VisitQuarter"":""" & rst.Fields("VisitQuarter").Value & ""","
            jsonData2 = jsonData2 & """VisitationCostF"":""" & rst.Fields("VisitationCostF").Value & ""","
            jsonData2 = jsonData2 & """VisitationCost"":""" & rst.Fields("VisitationCost").Value & ""","
            jsonData2 = jsonData2 & """PrevCost"":""" & rst.Fields("PrevCost").Value & ""","
            jsonData2 = jsonData2 & """Diff"":""" & rst.Fields("Diff").Value & ""","
            jsonData2 = jsonData2 & """PercentageChange"":""" & rst.Fields("PercentageChange").Value & ""","
            jsonData2 = jsonData2 & """ContPercentage"":""" & rst.Fields("ContPercentage").Value & """"
            jsonData2 = jsonData2 & "},"
            rst.MoveNext
            counter = counter + 1
        Loop
        jsonData2 = Left(jsonData2, Len(jsonData2) - 1) ' Remove the trailing comma
    End If
    ...
    ' Send the data to the client-side
    response.write "<script>"
    response.write "var dbDataYearly = " & jsonData2 & ";"
    response.write "document.addEventListener('DOMContentLoaded', function() {"
    response.write "    var revenueSourcesQuarterly = dbDataYearly.data;"
