...
Sub quarterlyVisitCostAnalysis()
    ...
    ' Define the layout for the chart
    response.write "    var barLayout = {"
    response.write "        title: 'Quarterly Visit Cost Analysis Between " & FormatDateNew(periodStart) & " And " & FormatDateNew(periodEnd) & " ',"
...
Sub monthlyVisitCostAnalysis()
    ...
    ' Define the chart data for a line chart
    response.write "    var trace = {"
    ...
    response.write "        marker: { color: 'blue' },"
    response.write "        line: { shape: 'linear' },"
    ...
    response.write "        textposition: 'top center',"
    response.write "        texttemplate: '%{y}',"
    response.write "        hovertemplate: '%{text}'"
    response.write "    };"
    ...
    response.write "        margin: { t: 50, b: 80, l: 60, r: 10 },"
    response.write "    };"
    response.write "    Plotly.newPlot('monthlyChartDiv', [trace], lineLayout);"
    response.write "});"
    response.write "</script>"
...
Sub weeklyVisitCostAnalysis()
    ...
    ' Define the layout for the chart
    response.write "    var lineLayout = {"
    response.write "        title: 'Weekly Visit Cost Analysis Between " & FormatDateNew(periodStart) & " And " & FormatDateNew(periodEnd) & " ',"
