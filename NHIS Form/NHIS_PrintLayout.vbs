...
Sub NHISForm()
  response.write " <body style='margin-top: 50px; margin-bottom: 50px' class='container'>"
  ...
  response.write "      <div class='form-no-and-hi-code' style='display: block'> "
  ...
  response.write "      <div "
  response.write "        class='surname-others-dob-hosp' "
  response.write "        style='display: flex; flex-direction: column' "
  response.write "      > "
  response.write "        <div style='display: flex'> "
  response.write "          <label for='surname' style='margin-right: 77.5px'>Surname:</label> "
  response.write "          <input type='text' id='surname' name='surname' /> "
  response.write "        </div> "

  response.write "        <div tyle='display: flex'> "
  response.write "          <label for='other-names' style='margin-right: 42px' "
  response.write "            >Other Names:</label "
  response.write "          > "
  response.write "          <input type='text' id='other-names' name='other-names' /> "
  response.write "        </div> "

  response.write "        <div tyle='display: flex'> "
  response.write "          <label for='other-names' style='margin-right: 43px' "
  response.write "            >Date of Birth:</label "
  response.write "          > "
  response.write "          <input type='date' id='other-names' name='other-names' /> "
  response.write "        </div> "

  response.write "        <div style='display: flex'> "
  response.write "          <label for='hospital-record' style='margin-right: 5px' "
  response.write "            >Hospital Record No:</label "
  response.write "          > "
  response.write "          <input type='text' id='hospital-record' name='hospital-record' /> "
  response.write "        </div> "
  response.write "      </div> "

  response.write "      <div> "
  response.write "        <label for='age'>Age:</label> "
  response.write "        <input type='number' id='age' name='age' /> "
  response.write "      </div> "

  response.write "      <div class='age-gender-member-claims'> "
  response.write "        <div> "
  response.write "          <label for='gender'>Gender</label> "
  response.write "          <input type='text' id='gender' name='gender' /> "
  response.write "        </div> "

  response.write "        <div> "
  response.write "          <label for='member-no'>Member No.:</label> "
  response.write "          <input type='text' id='member-no' name='member-no' /> "
  response.write "        </div> "

  response.write "        <div style='display: flex'> "
  response.write "          <label for='cliams-code'>Claims Check Code:</label> "
  response.write "          <input type='text' id='cliams-code' name='cliams-code' /> "
  response.write "        </div> "
  response.write "      </div> "
  response.write "    </div> "
  ...
  response.write "    <p> "
  response.write "      <strong>Services Provided</strong> "
  response.write "      <em>(to be filled by health care providers)</em> "
  response.write "    </p> "
...
Sub CSS_Styles()
  ...
  response.write" }"
  response.write" "
  response.write" /* I am done with this section */"
  ...
  response.write"   align-items: center;"
  response.write"   justify-content: space-between;"
  response.write"   /* border: 1px solid red; */"
  response.write" }"
  response.write" "
